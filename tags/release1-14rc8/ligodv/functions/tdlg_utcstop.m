...
stoputcInput = get(handles.tdlg_utcStop, 'String');
...
% set fields
set(handles.tdlg_utcStop, 'String', stoputc);
set(handles.tdlg_gpsStop, 'String', num2str(stopgps));
